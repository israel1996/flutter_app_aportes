...
class _EditFeligresSheetState extends ConsumerState<EditFeligresSheet> {
  ...
  bool _activo = true; // Controla si es usuario Activo o Inactivo
  ...
  void initState() {
    ...
    _activo = widget.feligres.activo == 1; // Cargamos el estado inicial
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // --- NUEVO INTERRUPTOR DE ESTADO (ACTIVO/INACTIVO) ---
              Container(
